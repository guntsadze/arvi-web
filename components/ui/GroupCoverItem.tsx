...
export const GroupCoverItem = ({
  ...
  return (
    <div
      className={cn(
        "h-48 md:h-64 bg-surface-1 relative group/cover overflow-hidden border-b border-border",
        className,
      )}
    >
      ...
      {/* 3. Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-t from-surface-1 via-transparent to-black/20" />
      ...
      {isOwner && (
        <div className="absolute inset-0 z-30 flex items-center justify-center bg-black/40 backdrop-blur-[2px] opacity-0 group-hover/cover:opacity-100 transition-all duration-300">
          <div className="flex flex-col items-center gap-3">
            ...
            <span className="font-mono text-[10px] text-accent uppercase tracking-[0.2em] bg-black/80 px-3 py-1.5 border border-accent/30 shadow-2xl">
      ...
      <div className="absolute top-4 left-4 w-4 h-4 border-t-2 border-l-2 border-border opacity-50" />
      <div className="absolute top-4 right-4 w-4 h-4 border-t-2 border-r-2 border-border opacity-50" />
