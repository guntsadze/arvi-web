...
export const GlobalLoader = () => {
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#1a1816]">
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="relative w-24 h-24 mb-8">
          ...
          <motion.div
            ...
            className="absolute inset-0 border-t-2 border-r-2 border-orange-500/30 rounded-full"
          />
          ...
          <motion.div
            ...
            className="absolute inset-2 border-b-2 border-l-2 border-orange-500 rounded-full"
          />
        ...
        <div className="flex flex-col items-center gap-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono font-black text-stone-300 uppercase tracking-[0.5em] animate-pulse">
              მონაცემები იტვირთება
            </span>
          </div>

          {/* პროგრესის იმიტაცია (დეკორატიული) */}
          <div className="w-48 h-[2px] bg-stone-900 overflow-hidden relative">
            <motion.div
              initial={{ x: "-100%" }}
              animate={{ x: "100%" }}
              transition={{
