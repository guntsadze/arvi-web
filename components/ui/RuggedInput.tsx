...
export const RuggedInput = <T extends FieldValues>({
  ...
  <div className={`relative group ${fullWidth ? "col-span-full" : ""}`}>
    ...
    <div className="relative">
      ...
      <div className="absolute top-0 right-0 w-2 h-2 border-t border-r border-stone-500 group-focus-within:border-amber-500 skew-x-[-6deg]" />
      <div className="absolute bottom-0 left-0 w-2 h-2 border-b border-l border-stone-500 group-focus-within:border-amber-500 skew-x-[-6deg]" />
