  ...
  <div className="bg-[#201d1b] border border-stone-800 p-6 h-full">
    ...
    <div className="prose prose-invert max-w-none">
      {car.description ? (
        ...
        <div className="text-stone-300 font-mono italic text-sm py-10 text-center border-2 border-dashed border-stone-800">
    ...
    <div className="mt-8 pt-6 border-t border-stone-800">
      <div className="flex justify-between items-center text-[10px] font-mono text-stone-300 uppercase">
