  ...
  return (
    <div className="relative mb-8 group/card">
      <div className="bg-surface-1 border border-border hover:border-border transition-colors duration-300 overflow-hidden">
        ...
        {/* Avatar preview */}
        <div className="flex items-center justify-center py-10 bg-surface-2 border-b border-border">
          <div className="relative">
            ...
            <img
              ...
              className="relative w-32 h-32 rounded-full object-cover border-2 border-accent/50"
            />
